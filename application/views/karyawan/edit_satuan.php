...
<head>
  ...
  <title><?=$user['sub_department']?> | Tambah Data Satuan</title>
          ...
          <div class="col-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                ...
                <form action="" name="satuanForm" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="id" name="id" value="<?=$satuan['id'] ?>" autocomplete="off" readonly hidden required>
                            <input type="text" class="form-control" placeholder="Satuan" id="satuan" name="satuan" value="<?=$satuan['satuan'] ?>" autocomplete="off" required>
    ...
    if (!isValid) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          var formData = $('form[name="satuanForm"]').serialize();
          $.ajax({
            url: '<?=base_url('valhein')?>',
            method: 'POST',
            data: formData,
            dataType: 'xml',
            success: function(response) {
                ...
                if(status === 'true'){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed){
                          window.location.href = '<?=base_url('omen')?>';
                        }
                    })
            ...
            error: function(xhr, status, error) {
              ...
              Swal.fire({
                icon: 'error',
                title: 'Terjadi kesalahan saat mengupdate satuan',
                showConfirmButton: true,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Oke'
              });
