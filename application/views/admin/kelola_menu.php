...
<head>
    ...
    <title><?=$user['sub_department']?> | Kelola Menu</title>
                                ...
                                <tbody>
                                    <?php foreach($all_menus as $m): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <?php foreach ($m['access_users'] as $asu): ?>
                                                        <li><?= $asu['nama'] ?> (<?= $asu['role'] ?>)</li>
                                                    <?php endforeach; ?>
                                                </ul>
                                            </td>
                                            <td>
                                                <a href="<?=base_url('kesi/'.$m['id'])?>" class="btn btn-sm btn-primary">
