...
<head>
    ...
    <title><?=$user['sub_department']?> | Kelola Akses Report</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    <?php $i=1; foreach ($managers as $manager): ?>
                                        <tr>
                                            <td><?= $i++; ?></td>
                                            <td><?= $manager['nama'] ?></td>
                                            ...
                                            <td>
                                                <ul>
                                                    <?php foreach ($manager['pic'] as $pic): ?>
                                                        <li><?= $pic['nama'] ?></li>
                                                    <?php endforeach; ?>
                                                </ul>
                                            </td>
                                            <td>
                                                <ul>
                                                    <?php foreach ($manager['reports'] as $report): ?>
                                                        <li><?= $report['report'] ?> (<?=$report['sub_report']?> - <?=$report['status']?>)</li>
                                                    <?php endforeach; ?>
                                                </ul>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('slimz/'.$manager['id']) ?>" class="btn btn-sm btn-primary">
