          ...
          <div class="col-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Edit Data Department</h3>
              </div>
                <form action="" name="editForm" method="POST">
                  <div class="card-body">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Kode Department" name="kodedept" value="<?=$dataTarget['kode']?>" autocomplete="off" required>
                    </div>
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-landmark"></i></span>
                      </div>
                      <input type="text" class="form-control" placeholder="Department" name="department" value="<?=$dataTarget['department']?>" autocomplete="off" required>
                    </div>
                      
                    <input type="text" class="form-control" id="id" name="id" readonly value="<?=$dataTarget['id']?>" hidden>
    ...
    if (!isValid) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: '<?=base_url('ryoma')?>', // Sesuaikan URL dengan URL tujuan submit form
            type: 'POST',
            data: formData,
            success: function(response) {
              ...
              Swal.fire({
                icon: 'success',
                title: 'Department berhasil diupdate !',
                showConfirmButton: true,
                confirmButtonColor: '#3085d6'
              }).then(()=>{
                location.reload();
