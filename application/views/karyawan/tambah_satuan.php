          ...
          <div class="col-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Data Satuan</h3>
              </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Satuan Baru" id="newSatuan" name="newSatuan" autocomplete="off" required>
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            error: function(xhr, status, error) {
              ...
              Swal.fire({
                icon: 'error',
                title: 'Terjadi kesalahan saat menambah satuan',
                showConfirmButton: true,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Oke'
              });
