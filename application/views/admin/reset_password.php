...
<head>
  ...
  <title><?=$user['sub_department']?> | Reset Password</title>
          ...
          <div class="col-5">
            ...
            <div class="card card-info">
              <div class="card-header">
                ...
                <form action="<?=base_url('quillen')?>" name="userForm" method="POST">
                    <div class="card-body">

                        <div class="form-group">
                            <label>Nama User</label>
                            <select class="form-control" id="id_nama" name="id_nama" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" class="form-control" placeholder="Password" name="password" id="password" required value="1234">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-block btn-primary btnReset" id="btnReset" name="btnReset">Reset</button>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </form>
      ...
      if ($('#id_nama').val() === "") {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $('form[name="userForm"]').unbind('submit').submit();
          }
        });
      }
    });
